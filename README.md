...
- `v3.2.0`
  - 继续完成 v3 系列 UI 精修，统一桌面端与移动端的视觉语言与信息层级
  - 新增滚动收缩式头部（collapsible header），在保留品牌感的同时减少总览区对正文的长期挤压
  - 重做顶部品牌标识，新增 `BrandMarkIcon`，将左上角从普通字母标识升级为“小锤子”专属品牌符号
  - 继续收紧总览与检修页的布局密度，优化视图切换区、页脚、统计卡、会话卡、长期账本与趋势图的阅读节奏
  - 完成新一轮响应式优化，重点修正手机端 header 过厚、卡片宽度利用率不足、布局空白与信息承载偏低等问题
  - 将整体风格进一步从“技术面板”收敛到“可长期使用的 AI 工作台 / 运维控制台”
- `v3.0.0`
